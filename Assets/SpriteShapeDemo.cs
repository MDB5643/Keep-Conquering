...
public class SpriteShapeDemo : MonoBehaviour
{
    ...
    public void DrawDebug()
    {
        ...
        for (int i = 0; i < triangles.Length; i = i + 1)
        {
            ...
            Debug.DrawLine(vertices[a] + new Vector2(transform.position.x, transform.position.y), vertices[b] + new Vector2(transform.position.x, transform.position.y), Color.red, 100.0f);
            Debug.DrawLine(vertices[b] + new Vector2(transform.position.x, transform.position.y), vertices[c] + new Vector2(transform.position.x, transform.position.y), Color.red, 100.0f);
            Debug.DrawLine(vertices[c] + new Vector2(transform.position.x, transform.position.y), vertices[a] + new Vector2(transform.position.x, transform.position.y), Color.red, 100.0f);
        }
    }
