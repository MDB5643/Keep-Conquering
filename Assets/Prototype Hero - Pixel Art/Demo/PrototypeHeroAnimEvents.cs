...
public class PrototypeHeroAnimEvents : MonoBehaviour
{
    ...
    void AE_AttackAirLanding()
    {
        ...
        activeHitbox = Instantiate(dairHitbox, new Vector2((m_player.transform.position.x), m_player.transform.position.y),
    ...
    void AE_SwordAttack()
    {
        ...
        activeHitbox = Instantiate(upTiltHitbox, new Vector2((m_player.transform.position.x + xDisplace), m_player.transform.position.y),
            rotQuat, m_player.transform);
        StartCoroutine(Linger());
        c_Manager.hitEnemy = "None";
    }
    ...
    void AE_JabHitbox()
    {
        ...
        activeHitbox = Instantiate(jab1Hitbox, new Vector2((m_player.transform.position.x + xDisplace), m_player.transform.position.y),
            rotQuat, m_player.transform);
        StartCoroutine(Linger());
        c_Manager.hitEnemy = "None";
    }
    ...
    private IEnumerator Linger()
    {
        ...
        yield return new WaitForSeconds(lingerDeltaTime);
