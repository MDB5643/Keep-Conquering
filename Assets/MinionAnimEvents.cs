...
public class MinionAnimEvents : MonoBehaviour
{
    ...
    void AE_SwordAttack()
    {
        ...
        activeHitbox = Instantiate(attack1HB, new Vector3((m_player.transform.position.x + xDisplace), m_player.transform.position.y + .19f, m_player.transform.position.z),
